...
const loanApproveModel = new mongoose.Schema({
    ...
    lead_status : {type: String,enum : ['EMPTY','PENDING','APPROVED','REJECTED','DISBURSED','ONGOING','CLOSED','ACTIVE'],default : 'PENDING'},
...
const LoanOngoingModel = mongoose.model('LoanOngoingModel', loanApproveModel);

module.exports = LoanOngoingModel;

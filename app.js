...
app.post("/delete-approved-collection", user.deleteApprovedCollection);
app.post("/delete-rejected-collection", user.deleteRejectedCollection);
...
app.post(
  "/upload-lead-pdf",
  uploadMiddleWare.single("cibil_pdf"),
  user.uploadLeadCibilPdf
);
